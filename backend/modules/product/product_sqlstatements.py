...
CREATE_PRODUCT_ITEM = """ 
INSERT INTO product (id, name, description, quantity, price, is_active, created_at, updated_at, created_by, updated_by) 
VALUES (:id, :name, :description, :quantity, :price, :is_active, :created_at, :updated_at, :created_by, :updated_by) 
RETURNING id, name, description, quantity, price, is_active, created_at, updated_at, created_by, updated_by; 
"""
